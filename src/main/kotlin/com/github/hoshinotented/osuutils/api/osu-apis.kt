...
import com.github.hoshinotented.osuutils.api.Authentication.sendAuthedRequest
import com.github.hoshinotented.osuutils.api.OsuApi.client
import com.github.hoshinotented.osuutils.api.OsuApi.deJson
import com.github.hoshinotented.osuutils.api.OsuApi.logger
...
object Beatmaps {
  ...
  /**
   * @param scoreId note that this is not [Score.id], but [com.github.hoshinotented.osuutils.api.data.ScoreUserAttribute.Pin.scoreId]
   */
